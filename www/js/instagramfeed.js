...
var $accessToken = "9607364831.1677ed0.dd42539d37cd40578643947ddf983192";
  // ADD YOUR USER ID HERE ~ THIS IS THE FIRST SECTION OF THE IG TOKEN EG. 1234567890 
var $userID = "9607364831";
    ...
    if($accessToken === '') {
      ...
      ig.build = function(data, args) {
        ...
        $.each(data.data,function (i,item) {
          ...
          args.html += '<a class="image" style="background-image: url('+img+');" data-img="'+hires+'">';
